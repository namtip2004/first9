<style>
	#btnConfirm{  
		padding: 5px 10px;color: #F0F0F0;background-color: #39ABF6;
	}
	table{
		width: 100%;
	}
...
?>
	<tr>
				...
				<td align=right><?php echo "$".($item["quantity"].$item["price"]); ?></td>
...
<td align=right><a id="btnEmpty" class="cart-action" onClick="cartAction('empty','');">Empty Cart</a></td>
</tr>
<tr>
