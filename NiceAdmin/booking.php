        ...
        <form id="bookingForm" action="submit_booking.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="promotion" name="promotion_id" onchange="calculatePrices()">
                    ...
                    $promotions = $pdo->query("SELECT promotion_id, pm_name, discount, apply_to_all FROM promotion WHERE active = '1' AND pm_start_date <= '$today' AND pm_end_date >= '$today'")->fetchAll(PDO::FETCH_ASSOC);
