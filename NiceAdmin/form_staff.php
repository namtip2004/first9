        ...
        <div class="col-lg-12 ">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="insert_staff.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="upload-box" id="uploadBox">
    ...
    <img id="previewImage" alt="Preview" />
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="email" class="form-control" id="floatingGmail" name="floatingGmail" placeholder="Your Gmail">
                    <label for="floatingEmail">Your Gmail</label>
                  </div>
                </div>
