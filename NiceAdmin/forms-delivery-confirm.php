    ...
    <div class="col-lg-12">
          ...
          <table style="width: 60%;">
                ...
                <tr>
                    ...
                    <td style="padding-bottom: 10px;">ที่อยู่ : <?=$row['address'];?></td>
                </tr>
...
<div class="card">
      ...
      <?php 
        ...
        ?>
          ...
          <!-- End Table Variants -->
          <form action="delivery_order_update.php" method="post" enctype="multipart/form-data">
            ...
            <div class="col col-sm-12" style="padding-bottom: 20px;">
                ...
                <div>
                <label>เลขที่จัดส่ง</label style="padding-bottom: 20px;">
                <input type="text" class="form control"
                    id="delivery_code" name="delivery_code">
                </div>

            </div>

            <div class="col">
                <button type="submit" name="submit" class="btn btn-outline-primary btn-sm">submit</button>
            </div>
          </form>
        </div>
      </div>
