            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="insert_customer.php" method="POST">
                ...
                <div class="col-md-6">
                  <div class="col-md-12">
                    <div class="form-floating">
                      <select class="form-select" id="floatingCity" name="floatingCity"  aria-label="City">
                ...
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select class="form-select" id="floatingProince" name="floatingProince"  aria-label="Proince">
                    <?php 
                    ...
                    <label for="floatingProince">Proince</label>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-floating">
...
<script type="text/javascript">
  $('#floatingProince').change(function() {
