...
<div class="card">
      ...
      <?php 
        ...
        ?>
          ...
          <!-- End Table Variants -->
          <form action="place_order_update.php" method="post" enctype="multipart/form-data">
            ...
            <div class="col col-sm-12" style="padding-top: 10px;">
                ...
                <input type="text" class="form control"
                    id="grand_total" name="grand_total" value="<?=$total;?>" readonly>
            </div>
