              ...
              <form class="row g-3" action="insert_product.php" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingProductName" name="floatingProductName" placeholder="Product Name">
                    <label for="floatingProductName">Product Name</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingDescription" name="floatingDescription" placeholder="Description">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="Price" class="form-control" id="floatingPrice" name="floatingPrice" placeholder="Price">
                    <label for="floatingPrice">Price</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="Stock" class="form-control" id="floatingStock" name="floatingStock" placeholder="Stock">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-5">
                  <input type="file" class="form control-file boeder" name="file">
