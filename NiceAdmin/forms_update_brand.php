...
// ดึงข้อมูลแบรนด์จากฐานข้อมูลตาม brand_id
$sql = "SELECT * FROM brand WHERE brand_id = $brand_id";
$result = mysqli_query($conn, $sql);
$brand = mysqli_fetch_assoc($result);
?>

<form class="row g-3" action="update_brand.php?id=<?=$brand['brand_id'];?>" method="POST">
  <div class="col-md-12">
    <div class="form-floating">
      <input type="text" class="form-control" id="BrandName" name="BrandName" placeholder="BrandName" value="<?=$brand['brand_name'];?>">
