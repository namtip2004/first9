...
// ดึงข้อมูลยี่ห้อจากฐานข้อมูล
$sql_brand = "SELECT * FROM brand ORDER BY brand_name";
$result_brand = mysqli_query($conn, $sql_brand);
?>

<!-- Floating Labels Form -->
<form class="row g-3" action="update_product.php?id=<?=$product['id'];?>" method="POST" enctype="multipart/form-data">
  <div class="col-md-12">
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingProductName" name="floatingProductName" placeholder="Product Name" value="<?=$product['name'];?>">
      <label for="floatingProductName">Product Name</label>
    </div>
  </div>
  <div class="col-md-12">
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingDescription" name="floatingDescription" placeholder="Description" value="<?=$product['description'];?>">
  ...
  <div class="col-md-6">
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingPrice" name="floatingPrice" placeholder="Price" value="<?=$product['price'];?>">
  ...
  <div class="col-md-6">
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingStock" name="floatingStock" placeholder="Stock" value="<?=$product['stock'];?>">
  ...
  <div class="col-md-6">
    <div class="form-floating mb-3">
      <select class="form-select" id="floatingBrand" name="floatingBrand" aria-label="Brand">
      <?php 
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-5">
      ...
      <img src="assets/img/<?=$product['image'];?>" alt="Product Image" class="img-thumbnail" style="max-width: 200px;">
    </div>
  </div>
