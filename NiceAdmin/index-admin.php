...
<nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets\img\pro1.jpg" alt="Profile" class="rounded-circle">
  ...
  <div class="card info-card sales-card">
    ...
    <div class="filter">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
        ...
        <li><a class="dropdown-item" href="#" onclick="changeReport('report_confrimcart.php', 'ทั้งหมด')">คำสั่งซื้อทั้งหมด</a></li>
        <li><a class="dropdown-item" href="#" onclick="changeReport('report_confrimcart_year.php', 'ปีนี้')">คำสั่งซื้อปีนี้</a></li>
        <li><a class="dropdown-item" href="#" onclick="changeReport('report_confrimcart_mount.php', 'เดือนนี้')">คำสั่งซื้อเดือนนี้</a></li>
        <li><a class="dropdown-item" href="#" onclick="changeReport('report_confrimcart_day.php', 'วันนี้')">คำสั่งซื้อวันนี้</a></li>
      </ul>
    </div>

    <div class="card-body">
      <h5 class="card-title" id="sales-title">Sales <span>| ทั้งหมด</span></h5> <!-- Default title -->
      <div class="d-flex align-items-center">
        ...
        <div class="ps-3">
          <h6 id="sales-report">
            <?php require_once("report_confrimcart.php"); ?>
          </h6>
        </div>
      </div>
    </div>
...
<script>
  function changeReport(reportFile, filterTitle) {
    // Use AJAX to fetch the content from the selected report file
    fetch(reportFile)
      .then(response => response.text())
      .then(data => {
        document.getElementById('sales-report').innerHTML = data; // Update the sales report section
        document.getElementById('sales-title').innerHTML = `Sales <span>| ${filterTitle}</span>`; // Update the title
      })
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6 id="sales-report-1"><?php require_once("report_money.php"); ?></h6>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <h6 id="sales-report-2"><?php require_once("report_customer.php"); ?></h6>
          ...
          <div class="col-12">
              <div class="card">
                  <div class="filter">
                    ...
                    <!-- Line Chart -->
                        <?php require_once("data-chart.php"); ?>
                   <!-- End Line Chart -->
                  </div>
              </div>
           </div><!-- End Reports -->  
          ...
          <div class="col-12">
              <div class="card">
                  <div class="filter">
                    ...
                    <h5 class="card-title">Reports <span>/Today</span></h5>
                    <!-- Line Chart -->
                        <?php require_once("data-chart-best-sale.php"); ?>
                   <!-- End Line Chart -->
                  </div>
              </div>
           </div><!-- End Reports --> 
