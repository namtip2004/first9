          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">คำสั่งซื้อสำเร็จ</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <h6 id="sales-report-customer1"><?php require_once("report_customer_buy.php"); ?></h6>
            ...
            <!-- Sales Card -->
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">คำสั่งซื้อกำลังดำเนินการ</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <h6 id="sales-report-customer1"><?php require_once("report_customer_buy2.php"); ?></h6>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">ยอดสั่งซื้อทั้งหมด</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <h6 id="sales-report-customer1"><?php require_once("report_customer_buy3.php"); ?> Baht</h6>
                    </div>
                  </div>
                </div>
...
<div class="col-12">
              <div class="card">
                  <div class="filter">
                    ...
                    <!-- Line Chart -->
                        <?php require_once("data-chart-customer.php"); ?>
                   <!-- End Line Chart -->
                  </div>
              </div>
           </div><!-- End Reports --> 
