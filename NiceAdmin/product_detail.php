...
$sql = "SELECT * FROM products INNER JOIN brand 
...
<div class="row g-3">
  <div class="col-md-12">
    <div class="form-floating">
      <p class="form-control" id="floatingProductName" name="floatingProductName"><?=$product['name'];?></p>
      <label for="floatingProductName">Product Name</label>
    </div>
  </div>
  <div class="col-md-12">
    <div class="form-floating">
      <p class="form-control" id="floatingDescription" name="floatingDescription"><?=$product['description'];?></p>
  ...
  <div class="col-md-6">
    <div class="form-floating">
      <p class="form-control" id="floatingPrice" name="floatingPrice"><?=$product['price'];?></p>
      <label for="floatingPrice">Price</label>
    </div>
  </div>
  <div class="col-md-6">
    <div class="form-floating">
      <p class="form-control" id="floatingStock" name="floatingStock"><?=$product['stock'];?></p>
  ...
  <div class="col-md-6">
    <div class="form-floating mb-3">
      <p class="form-select" id="floatingBrand" name="floatingBrand" aria-label="Brand" disabled><?=$product['brand_name'];?></p>
