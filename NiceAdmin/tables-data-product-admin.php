            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <?php 
                    ...
                    ?>
                    <tr>
                        <td><img src="<?='assets/img/'.$row['image']?>" alt="" width="100" height="100" ></td>
                        <td><?=$row['name'];?></td>
                        <td><?=$row['price'];?></td>
                        <td><?=$row['brand_name'];?></td>
                        <td><?=$row['stock'];?></td>
                        <td><a class="btn btn-outline-primary btn-sm"
                        href="product_detail.php?id=<?=$row['id']?>">รายละเอียดเพิ่มเติม</a>
                        </td>
                        <td><a class="btn btn-outline-primary btn-sm"
                        href="forms_update_product.php?id=<?=$row['id']?>">แก้ไข</a></td>
                        <td><a class="btn btn-outline-primary btn-sm"
                        href="delete_product.php?id=<?=$row['id']?>">ลบ</a></td>
