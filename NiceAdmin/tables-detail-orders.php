  ...
  <div class="row">
    <div class="col-lg-12">
          ...
          <table style="width: 60%;">
                ...
                <td>วันที่ชำระเงิน : <?=$row['pay_date']. " เวลา : ".$row['pay_time'];?></td>     
                </tr>
          ...
          <tr>
          <td style="padding-top: 10px;" >สถานะการจัดส่ง :
                  <?php if($row['status']==0)
                          echo "รอชำระเงิน";
                            else if($row['status']==1)
                                echo "รอตรวจสอบจาก Admin";
          ...
          <td>วันที่จัดส่ง : <?=$row['delivery_date'] ?></td>
          </tr>
          <tr>
           <td colspan="2" style="padding-bottom: 10px;">เลขที่จัดส่ง : <?=$row['delivery_code'] ?></td>
          </tr>
          </table>
