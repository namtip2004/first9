            ...
            <div class="card-body">
              ...
              <p>Add lightweight datatables to your project with using the <a href="https://github.com/fiduswriter/Simple-DataTables" target="_blank">Simple DataTables</a> library. Just add <code>.datatable</code> class name to any table you wish to conver to a datatable. Check for <a href="https://fiduswriter.github.io/simple-datatables/demos/" target="_blank">more examples</a>.</p>
                ...
                <?php 
                    ...
                    $sql = "select * from orders where status=3 order by order_id";
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th>ชื่อลูกค้า</th>
                    <th data-type="date" data-format="YYYY/DD/MM">วันที่สั่งซื้อ</th>
                    <th>จำนวนเงิน</th>
                    <th>ดูรายละเอียด</th>
                    <th>สถานะชำระเงิน</th>
                    <th>สถานะจัดส่ง</th>
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        href="tables-detail-orders.php?order_id=<?=$row['order_id']?>">รายละเอียด</a>
                        </td>
                        <td>
                       <?php if($row['status']==0)
                          echo "รอชำระเงิน" ;
                          ...
                          <a class="btn btn-outline-primary btn-sm"
                          href="forms-admin-confirm.php?order_id=<?=$row['order_id']?>">รออนุมัติ</a>
                          <?php } else if($row['status']==2||$row['status']==3)
                        ...
                        <?php if($row['status']==0)
                          echo "รอชำระเงิน";
                            ...
                            <a class="btn btn-outline-primary btn-sm"
                          href="forms-delivery-confirm.php?order_id=<?=$row['order_id']?>">รอจัดส่ง</a>
                            <?php }
